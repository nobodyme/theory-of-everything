      ...
      <div className="wrap">
        <div className="reveal">
          <div className="eyebrow">
            <span className="chno">Prologue</span> The clerk nobody wanted
          </div>
          <h2>
            The most unlikely address <em>in physics</em>
          </h2>
        </div>
        <div className="prologue-grid">
          <div className="prose reveal">
            ...
            <p>
              Evenings, he ran a self-styled reading club with two friends — grandly named{' '}
              <b>the Olympia Academy</b> — working through the era's most dangerous books:
              Mach, Hume, Poincaré. No laboratory. No professor. No new data.{' '}
              <b>Just the world's existing knowledge, read very, very carefully.</b>
            </p>
          </div>
          <div className="reveal">
            <div className="personnel">
              <div className="personnel-head">
                ...
                <span>File № 1905-AE</span>
              </div>
              <dl>
                <dt>Name</dt>
                <dd>Einstein, Albert</dd>
                <dt>Age</dt>
                <dd>26</dd>
                <dt>Position</dt>
                <dd>
